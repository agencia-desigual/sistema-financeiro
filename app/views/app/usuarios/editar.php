                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <p class="sub-title">Edite um usuário, o usuário admin tem o acesso completo ao sistema quando estiver ativo.</p>

                                <form id="formAlteraUsuario" data-alerta="swal" data-id="<?= $usuarios->id_usuario ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="nome" value="<?= $usuarios->nome ?>" required/>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-control" name="nivel" required>
                                                    ...
                                                    <option <?= ($usuarios->nivel == 'admin') ? 'selected' : '' ?> value="admin">Admin</option>
                                                    <option <?= ($usuarios->nivel == 'usuario') ? 'selected' : '' ?> value="usuario">Usuário</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div> 
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-control" name="status" required>
                                                    <option selected disabled >Selecione</option>
                                                    <option <?= ($usuarios->status == 1) ? 'selected' : '' ?> value="1">Ativo</option>
                                                    <option <?= ($usuarios->status == 0) ? 'selected' : '' ?> value="0">Desativado</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div> 
